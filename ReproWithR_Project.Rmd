...
#### Unfortunately, so far, there is no newer data in the dataset for this year
```{r}
...
ggplot(germany, aes(x = date_reported, y = as.numeric(Cumulative_number_for_14_days_of_COVID.19_cases_per_100000)))+
 ...
 scale_x_date(date_labels = "%Y/%m/%d") +
  labs(title = "Cumulative 14-day incidence per 100.000 inhabitants", subtitle = "Black line marks current goal for loosening")+
